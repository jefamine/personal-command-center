...
Раздел «Осмысление» — это фильтр документов единого рабочего пространства. Новая запись сразу является обычным документом с тегом `осмысление`, остаётся в хронологии и открывается тем же редактором без связанной копии. На главном экране под блоком остаются последние документы, поэтому начало нового не выглядит как исчезновение предыдущего. Чтение одного документа при разборе и чтение всей подборки разведены: подборка попадает в файловый снимок Codex только после отдельного переключателя в «Осмыслении» или «Интеграциях». Отдельной обязательной сущности «Дневник» нет.
