...
export type StandardWidgetType = Exclude<DashboardWidgetType, "custom">;
...
export const widgetRegistry: readonly WidgetDefinition[] = [
  ...
  { type: "reflection", defaultId: "reflection", title: "Записать и осмыслить", description: "Свободная мысль и бережный разбор", defaultSize: "two-thirds", defaultWidth: 8, defaultHeight: 5, minWidth: 6, enabledByDefault: true, defaultConfig: {} },
