...
import type { ReflectionDocument, ReflectionStatus } from "../../types";
import { createReflectionNote } from "./reflectionNote";
import {
...
function entry(status: ReflectionStatus): ReflectionDocument {
  const document = createReflectionNote(
    "Текст",
    "reflection-1",
